...
public class GeoapifyAddressClient implements AddressClient{
    ...
    // TODO: переписать с использованием Jackson
    ...
    // TODO: переписать с использованием RestTemplate
    private JSONObject sendGetRequest(String urlStr) {
        try {
            URL url = URL.of(URI.create(urlStr), null); // TODO: проверить, что работает
